...
:---|:---|
| fn | Функція-ітератор. Отримує два значення, нкопичувач(аккумулятор) і поточний елемент з масиву. За необхідності, загорнутий як трансформер і використовується для ініціалізації перетворювача |
