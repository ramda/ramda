...
module.exports = {
  ...
  tests: {
    ...
    'native findIndex(R.where({x: R.isEmpty}))': function() {
      objs.findIndex(R.where({x: R.isEmpty}));
    },
    'native findIndex(R.whereEq({y: false}))': function() {
      objs.findIndex(R.whereEq({y: false}));
    }
  }
};
