 ...
 * each key in 'keys' through `fn`. `fn` is passed one argument: *(value)*.
 *
 * @func
 * @memberOf R
 * @category Object
 * @sig (v -> v) -> [v] -> {k: v}
 * @param {Function} fn A function called for each key in `keys`. Its return value will
 ...
 * @example
 *
 *      R.mapKeys(R.toUpper, ['a', 'b', 'c']); //=> {a: 'A', b: 'B', c: 'C'}
 */
module.exports = _curry2(function mapObject(fn, keys) {
