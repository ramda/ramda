...
describe('addDefault', function() {
  ...
  it('returns the default value if origin fn\' result is null, undefined or NaN', function() {
    eq('defaultVal', addDefaultVal(null));
    eq('defaultVal', addDefaultVal(undefined));
    eq('defaultVal', addDefaultVal(NaN));
  });

  it('returns the fn\' result if it is not null/undefined/NaN', function() {
    eq('a real value', addDefaultVal('a real value'));
  });

  it('returns the fn\' result even if it is considered falsy', function() {
    eq('', addDefaultVal(''));
