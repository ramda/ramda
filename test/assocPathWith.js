...
describe('assocPathWith', function() {
  it('makes a shallow clone of an object, overriding only what is necessary for the path', function() {
    ...
    var obj2 = R.assocPathWith(['f', 'g', 'i'], R.always({x: 42}), obj1);
    eq(obj2,
  ...
  it('applies function to the value at the end of the path', function() {
    var obj1 = {a: {b: 1, c: 2, d: {e: 3}}, f: {g: {h: 4, i: 5, j: {k: 6, l: 7}}}, m: 8};
    var obj2 = R.assocPathWith(['f', 'g', 'i'], R.add(2), obj1);
    var obj3 = R.assocPathWith(['f', 'g', 'i'], R.multiply(2), obj1);
    var obj4 = R.assocPathWith(['f', 'g'], R.keys, obj1);
    eq(obj2,
  ...
  it('is the equivalent of clone and setPath if the property is not on the original', function() {
    ...
    var obj2 = R.assocPathWith(['x', 'y', 'z'], R.always({w: 42}), obj1);
  ...
  it('is curried', function() {
    ...
    var f = R.assocPathWith(['f', 'g', 'i']);
    var g = f(R.always({x: 42}));
    eq(f(R.always({x: 42}), obj1), expected);
    eq(g(obj1), expected);
  });
