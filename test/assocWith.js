...
describe('assocWith', function() {
  it('makes a shallow clone of an object, overriding only the specified property', function() {
    ...
    var obj2 = R.assocWith(R.always({x: 42}), 'e', obj1);
  ...
  it('is the equivalent of clone and set if the property is not on the original', function() {
    var obj1 = {a: 1, b: {c: 2, d: 3}, e: 4, f: 5};
    var obj2 = R.assocWith(R.always({x: 42}), 'z', obj1);
  ...
  it('is curried', function() {
    ...
    var f = R.assocWith(R.always({ x: 42 }));
    var g = f('e');
    eq(f('e', obj1), expected);
    eq(g(obj1), expected);
  });

  it('will apply undefined to the fn in the case where no property exists', function() {
    var obj1 = {a: 1, b: {c: 2, d: 3}, e: 4, f: 5};
    var obj2 = R.assocWith(R.identity, 'g', obj1);
