...
describe('mathMod', function() {
  ...
  it('computes the true modulo function', function() {
    ...
    assert.strictEqual(R.eqNaN(R.mathMod(17, -5)), true);
    assert.strictEqual(R.eqNaN(R.mathMod(17, 0)), true);
    assert.strictEqual(R.eqNaN(R.mathMod(17.2, 5)), true);
    assert.strictEqual(R.eqNaN(R.mathMod(17, 5.5)), true);
  });
