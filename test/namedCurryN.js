...
describe('namedCurryN', function() {
  it('curries a single value', function() {
    var f = R.namedCurryN(4, function({a, b, c, d}) {return (a + b * c) / d;}); // f(12, 3, 6, 2) == 15
    var g = f({ a: 12 });
    eq(g({ b: 3, c: 6, d: 2 }), 15);
  });
  ...
  it('properly reports the length of the curried function', function() {
    var f = R.namedCurryN(4, function({a, b, c, d}) {return (a + b * c) / d;});
    eq(f.length, 1);
    var g = f({a: 12});
    eq(g.length, 1);
    var h = g({b: 3});
  ...
  it('supports @@functional/placeholder', function() {
    ...
    eq(g({a:_, b:_, c:_})({a:_, b:_})({c:_})({a:1, b:2, c:3}), [1, 2, 3]);
    eq(g({a:_, b:_, c:_})({a:1, b:_, c:_})({a:_, b:_})({b:2, c:_})({c:_})({c:3}), [1, 2, 3]);
  });
